...
$template  = "/mnt/d/Mojtaba/LOCAL MODELS/Qwen3.5-4B BF16 Local/no_think.jinja"

Write-Host "============================================================" -ForegroundColor Cyan
Write-Host "  Qwen3.5-4B BF16 - vLLM Server (WSL2)" -ForegroundColor Cyan
Write-Host "  http://localhost:$port   ~70 tok/s" -ForegroundColor Cyan
